...
static const char col_gray2[]       = "#baffff";
...
static const unsigned int alphas[][3] = {
	/*               fg         bg         border   */
        [SchemeNorm] = { OPAQUE, 0x4C, 0x4C },
        [SchemeSel]  = { OPAQUE, 0xB2, OPAQUE },
};
/* tagging */
static const char *tags[] = { "󰼎", "󰼏", "󰼐", "󰼑", "󰼒", "󰼓", "󰼔", "󰼕", "󰼖" };
...
static const Key keys[] = {
	...
	// Poweroff script
	{ MODKEY,                       XK_s,      spawn,          SHCMD("powerrofi") },
	// Wifi Menu
	{ MODKEY,                       XK_w,      spawn,          SHCMD("wifirofi") },
	// Theme selector
	{ MODKEY,                       XK_r,      spawn,          SHCMD("themerofi") },
	// Take screenshot
	{ ControlMask|ShiftMask,           XK_s,      spawn,          SHCMD("mate-screenshot -d 10") },
};
